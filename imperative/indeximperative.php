...
<boby>
    ...
    <a href="createimperative.php"><button type="button" class="btn btn-primary">เพิ่มข้อมูล</button></a> <br>
    <br>
</boby>
<?php
...
<table class="table table-bordered" align="center" width=65% border=1 cellpadding=4>
    ...
    ?>
        <tr align="center">
            ...
            <td><a href='editimperative.php?ID=<?php echo $info['ID']; ?>'><button type="button" class="btn btn-warning">แก้ไข</button></a></td>
