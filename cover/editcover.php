...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <title>แก้ไขข้อมูลหัวเรื่อง</title>
...
$data = mssql_query("SELECT * FROM cover WHERE ID={$ID}")
    or die(mssql_error());
...
<body>
    ...
    ?>
        ...
        <form action="cover/updatecover.php?ID=<?php echo $info['ID']; ?>" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="POST" enctype="multipart/form-data">
            <br>
            <div align="center">
                <h2>ฟอร์มแก้ไขข้อมูลหัวเรื่อง</h2>
            </div>
